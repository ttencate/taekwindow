...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="information" xml:space="preserve">
		...
		namespace TaekwindowConfig {
			...
			public static class VersionInfo
			{
				...
				public const string MainExeFile = "<xsl:value-of select="mainexefile"/>";
				public const string HooksDllFile = "<xsl:value-of select="hooksdllfile"/>";
				public const string ConfigExeFile = "<xsl:value-of select="configexefile"/>";
